    ...
    <main>
        <div class="container">
            <div class="form-container">
                <h2 class="form-title">Editar Serie {{ $serie->seriecreada_id }}</h2>
                
                <form id="seriesForm" method="POST" action="{{ route('serie.update', $serie->seriecreada_id )}}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
