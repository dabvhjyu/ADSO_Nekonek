            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('neko/principal') }}">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('neko/biblioteca') }}">Biblioteca</a>
                        </li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            @if (Auth::user()->rol_id_fk == '1')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('neko\administrador') }}">
                                        <i class="fas fa-user-shield me-2"></i>Gestion
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('neko/configuracion') }}">
                                        <i class="fas fa-bell me-2"></i>notificaones
                                    </a>
                                </li>
                            @endif
                            @if (Auth::user()->rol_id_fk == '3')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('neko/grupos') }}">
                                        <i class="fas fa-users me-2"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href={{ route('nekocrear') }}>
                            ...
                            @if (Auth::user()->rol_id_fk == '2')
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('neko/perfil') }}" data-bs-toggle="tooltip"
                                        title="Mi Perfil">
                                        <i class="fas fa-id-card"></i> <!-- Icono moderno de perfil -->
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('neko/creargrupo') }}" data-bs-toggle="tooltip"
                                        title="Crear Grupo">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ url('neko/perfil') }}">
